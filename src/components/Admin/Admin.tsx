...
import { Shield, Brain, Settings as SettingsIcon, MessageSquare, CreditCard, BarChart3, Bug, Video, DollarSign } from 'lucide-react';
...
import { StripeCatalogManager } from './StripeCatalogManager';
import { useTheme } from '../../hooks/useTheme';

type AdminTab = 'ai-models' | 'ai-parameters' | 'prompts' | 'subscriptions' | 'marketing' | 'bugs' | 'videos' | 'stripe-catalog';
...
const adminTabs = [
  ...
  { id: 'stripe-catalog' as const, label: 'Catalogue Stripe', icon: DollarSign },

...
export function MarketHeader({ onCTAClick }: MarketHeaderProps) {
  return (
    <div className="bg-gradient-to-br from-orange-500 to-orange-700 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center justify-center">
          ...
          <a
            ...
            className="text-white border-2 border-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-orange-600 transition-colors"
          >

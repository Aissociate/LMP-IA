            ...
            {market.amount && (
              <div className="bg-orange-50 rounded-lg p-6 border border-orange-100">
                <div className="flex items-center space-x-3 mb-2">
                  ...
                  <p className="text-sm text-orange-900 font-medium">Montant estimé</p>
                </div>
                <p className="text-2xl font-bold text-orange-600">{formatAmount(market.amount)}</p>
              </div>
            )}
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {market.url && (
                  <a
                    ...
                    className="flex items-center justify-between p-6 bg-orange-50 border border-orange-200 rounded-lg hover:bg-orange-100 transition-colors group"
                  >
